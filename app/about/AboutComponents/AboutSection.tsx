    ...
    return (
        <section className="bg-white px-side-spacing py-section-spacing">
            <div className="container mx-auto lg:max-w-[70%]">
                <h1 className="text-3xl font-bold mb-6">Blenheim&apos;s Trusted Painting Experts</h1>
                <div className="lg:flex lg:items-center lg:space-x-8">
                    <div className="lg:w-1/2 mb-6 lg:mb-0">
                        <Image 
                            src="/images/team/portrait.png" 
                            alt="Bradley Hamilton, founder of Lakeside Painting - Professional painter serving Blenheim, NZ with quality interior and exterior painting services since 2010" 
                            width={600} 
                            height={400} 
                    ...
                    <div className="lg:w-1/2">
                        <p className="mb-4">
                            Welcome to Lakeside Painting, Blenheim&apos;s premier painting and decorating service. Since our establishment in 2010, we&apos;ve been transforming homes and businesses across the region with our expert craftsmanship and attention to detail.
                        </p>
                        <p className="mb-4">
